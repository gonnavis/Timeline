export class TimelineService {
    originData = [//https://www.awesomestories.com/images/user/b4cbb7aae7.gif
    ...
    addTimeline = function (timeline, area_id) {

    }

    processTimelines = function (timelines) {
        for (var i = 0; i < timelines.length; i++) {
            timelines[i] = this.processTimeline(timelines[i]);
        }
    }

    data=this.processData(this.originData)
    rowData=this.getRows(this.data)
